...
$.fn.flipster = function(options) {
    ...
    if (isMethodCall) {
        ...
        var defaults = {
            ...
            enableMousewheel: false, // Enable scroll wheel navigation (up = left, down = right)
            ...
            prevText:         '&lsaquo;&lsaquo;',       // Changes the text for the Previous button
            nextText:         '&rsaquo;&rsaquo;'            // Changes the text for the Next button
        };
